...
parser.add_argument('--net_names', help='model names', type=str, default='net_lesion_resnet')
parser.add_argument('--main_net_name', help='main model ', type=str, default='net_lesion_resnet')
...
parser.add_argument('-lr_ls', '--lr_ls', type=float, default=0.0001)
...
parser.add_argument('--ds_ls', type=int, default=2)
...
parser.add_argument('--tsp_ls', type=str, default='0.77_5')
parser.add_argument('--tsp_lb', type=str, default='0.77_5')
parser.add_argument('--tsp_vs', type=str, default='0.77_5')
parser.add_argument('--tsp_aw', type=str, default='0.77_5')
parser.add_argument('--tsp_lu', type=str, default='0.77_5')
...
parser.add_argument('--sub_dir_rc', type=str, default='LUNA16')  # or all_ct_lesion_699
