...
from GridAttentionBlock3D import GridAttentionBlock3D
...
class unet_CT_single_att_dsv_3D(nn.Module):
    ...
    def __init__(self, base=0.5, n_classes=2, is_deconv=True, in_channels=1,
        ...
        filters = [int(x * self.base) for x in filters]
