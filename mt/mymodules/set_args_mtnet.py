...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument("--patch_xy", type=int, default=64, help="patch size along x and y axis")
    parser.add_argument("--patch_z", type=int, default=64, help="patch size along z axis")
    ...
    parser.add_argument('--valid_period1', help='valid_period', type=int, default=5)
