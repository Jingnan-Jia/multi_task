...
parser.add_argument("--boost_5", type=int, default=1, help="max epoch number")

parser.add_argument("--ld_model", type=str, default="", help="loaded model folder")
#models/lung/1606324643_742
